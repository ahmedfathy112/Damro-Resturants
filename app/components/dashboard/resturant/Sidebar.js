...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <>
      <button
        className="hidden max-md:block !fixed !text-center !top-20 !left-4 !z-[9999] !bg-blue-600 !shadow-lg !p-2 !rounded-lg !text-white !hover:bg-blue-700 !transition-colors"
